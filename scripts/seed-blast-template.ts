...
<div style="display:none;font-size:1px;color:#fffcf0;line-height:1px;max-height:0;overflow:hidden">${preheader}</div>
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#fffcf0;padding:24px 0;font-family:Helvetica,Arial,sans-serif;color:#1a2321">
  <tr><td align="center">
    <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border:1px solid #e6e2d3;border-radius:12px;overflow:hidden">
      ...
      <tr><td style="padding:0 40px 24px">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#fff8d9;border-radius:8px">
      ...
      <tr><td style="padding:20px 40px;border-top:1px solid #e6e2d3;background:#fffcf0;font-size:12px;line-height:1.6;color:#6b716e">
