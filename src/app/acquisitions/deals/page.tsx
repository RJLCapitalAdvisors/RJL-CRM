...
import { AQ_PIPELINES, aqDealStageTone, aqFullName, aqRoleColor, parseJsonList, propertyLine, usd } from "@/lib/acquisitions";
...
/**
/** The Deals board (Jonathan, Sep 24, 2026): its own page under Deals in the sidebar; the Pipeline dropdown holds the three lists. */
export default async function AqDealsBoardPage() {
  const pipeline = "deals" as const;
