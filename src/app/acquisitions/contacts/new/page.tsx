    ...
    <>
      ...
      <div className="mx-auto max-w-3xl px-8 py-6">
        <div className="card p-5">
          <AqContactForm buyerStages={buyerStages} operatorStages={operatorStages} c={{ companyId: str(sp.companyId) || null, roles: JSON.stringify((AQ_ROLES as readonly string[]).includes(role) ? [role] : []) }} companies={companies} propertyId={propertyId} action={createAqContact} />
        </div>
      </div>
    </>
  );
