...
import { Building2, Users, KanbanSquare, LayoutDashboard, Mail, FileText, Sparkles, Search, ClipboardList } from "lucide-react";
import "./globals.css";
...
const nav = [
  { href: "/", label: "To do", icon: LayoutDashboard },
