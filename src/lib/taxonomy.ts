...
export const INVESTMENT_TYPES = ["Senior Debt", "Mezz Debt", "Preferred Equity", "Participating Preferred Equity", "JV Equity", "Co-GP Equity", "Programmatic"] as const; // capital stack order, top down; Programmatic added 2026-09-07 (not in HubSpot)
