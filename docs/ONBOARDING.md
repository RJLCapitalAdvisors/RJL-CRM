...
8. **Use Ask the CRM before digging** ([Ask the CRM](https://rjl-crm.vercel.app/ask))
   The top item in the sidebar is a chat box over everything in the CRM: what is missing on a deal, who at a firm to call, what an investor said on any deal, which investors fit a deal, what is waiting on the Dashboard. Answers link back to the records. It only reads.
9. **Know the house rules**
